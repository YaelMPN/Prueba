// Pruebabasbyyayotoneinthebeatxd.cpp : Este archivo contiene la función "main". La ejecución del programa comienza y termina ahí.
//
...
int main()
{
	...
	printf("when haces tus momos en visual studio 2022");
	printf("El futuro es hoy oiste viejo");
